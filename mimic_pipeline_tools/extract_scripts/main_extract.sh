...
# Created: 5/28/2020
#
# Run this bash script from inside the mimic-iii-v1-4 folder in the
# mimic-pipeline-tools repo to extract a bunch of stuff from the
...
REPO_DATA_PATH='/n/dtak/mimic-pipeline-tools/mimic-iii-v1-4'
cd $REPO_DATA_PATH
